...
c.SlidesExporter.font_awesome_url = 'static/fonts/font-awesome.min.css'

## 
#  See also: HTMLExporter.jquery_url
c.SlidesExporter.jquery_url = 'static/jquery.min.js'
...
c.SlidesExporter.require_js_url = 'static/require.js'
